...
finite $$n$$ we can never quite box _all_ $$\bar{x}_n$$ inside the ball, only with high probability $$1-\delta$$.
...
This is a stronger statement as it implies that there exists an $$n$$ for which the probability for _all_
