...
$$SE[\bar{x}_n] \propto n^{-\frac{1}{2}}$$. This behavior is called the _squareroot law_.
...
Generally, how this is handled is via the _boostrap principle_, where either i) $$\sigma^2$$ is being estimated
