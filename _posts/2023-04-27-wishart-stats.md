...
> _Disclaimer:_ No one checked my the derivation below for errors, and I was tired when writing this up, so beware of possible mistakes (though I hope it's correct).
...
The second to last line uses $$ V\_{ij} = \mathrm{Cov}[ u_i, u_j] = \mathbb{E}[ u_i u_j] - \mathbb{E}[u_i] \mathbb{E}[u_j] = \mathbb{E}[ u_i u_j] - 0\cdot 0 = \mathbb{E}[ u_i u_j] $$.
...
$$(\Xi\circledast \Xi)_{(ij), (kl)} = \frac{1}{2}(\Xi_{ik}\Xi*{jl} + \Xi*{jk}\Xi\_{il})$$
